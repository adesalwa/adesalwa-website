...
def artikel(request):
    ...
    url = 'http://localhost:8000/dashboard/api/artikel/list/272c3b09ab613dab8d9e66637cf7a8b35fcf0e694d0266d2f4fcf84be55f928e'
    #basic auth
    user_login = "adesalwa"
    user_password = "adesalwa"
...
def artikel_post(request, x_api_key):
    ...
    if request.method == 'POST':
        ...
        content = {
            'status' : status.HTTP_405_NOT_ALLOWED,
